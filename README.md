...
☕ **Coffee Shop Analytics – Multi Platform Dashboard Project**
...
This dashboard was built using the same Excel dataset across all tools.
...
Pivot tables, slicers, charts, and management reporting dashboard.
<img width="662" height="376" alt="PowerBI Dashboard" src="https://github.com/user-attachments/assets/e725fa7b-9a4d-4bfe-8582-a90b809a5ca9" />



**Dataset**

Coffee shop transactional sales data including:
...
- Revenue split evenly across 3 stores
- Highest sales occurred on weekends
- Morning hours generated peak transactions
- Coffee products drove most revenue
